...
public class Consumer {
	...
	public RequestToken getRequestToken(String endpoint) throws OAuthServiceProviderException {
		...
		System.out
				.println("Consumer got responseString when requesting RequestToken..."
						+ responseString);

		OAuthMessage responseMessage = new OAuthMessage();
		try {
			// can throw an exception or return null if bad data...
	...
	public void getAuthorize(String endpoint) {

	}

	// returns null if something goes wrong
	public AccessToken getAccessToken(String endpoint, RequestToken requestToken)
			throws OAuthServiceProviderException, BadTokenStateException {
		...
		requestMessage.setCallback(config.getCallbackEndpoint());
		requestMessage.setVerifier("1966746");	//TODO
		requestMessage.createSignature(signatureMethod, config.getSecret());
	...
	public String accessProtectedResource(String endpoint, AccessToken accessToken, Hashtable queryParams)
			throws OAuthServiceProviderException, IOException {
	...
	public String accessProtectedResource(String endpoint, AccessToken accessToken, Hashtable queryParams, String httpMethod)
			throws OAuthServiceProviderException, IOException {
		String responseString = null;
		OAuthMessage requestMessage = new OAuthMessage();
